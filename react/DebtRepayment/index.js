...
export default function DebtRepayment(props) {
  return React.createElement("svg", _extends({
    ...
    d: "M372.792 291.219l-70.963 70.963c-7.998 7.998-7.998 20.965 0 28.963s20.965 7.998 28.963 0l70.963-70.963c7.998-7.998 7.998-20.965 0-28.963s-20.965-7.998-28.963 0z"
  }), React.createElement("path", {
    d: "M400.018 435.165l-70.963-70.963c-7.998-7.998-20.965-7.998-28.963 0s-7.998 20.965 0 28.963l70.963 70.963c7.998 7.998 20.965 7.998 28.963 0s7.998-20.965 0-28.963z"
  }));
}